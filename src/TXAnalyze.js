...
class Pattern_ArDriveFee extends Pattern_ArFS_TX
{
    constructor () 
    {
        super ();
        this.WithRequirement ("Type", "fee");
        this.WithDescription ("ArDrive-fee");
    }
}

// These were generated by ardrive-cli at one point.
class Pattern_ArDriveFee2 extends Pattern_ArFS_TX
{
    constructor () 
    {
        super ();
        this.WithRequirement ("Type", "data upload");
        this.WithDescription ("ArDrive-fee");
    }
}
...
[
    ...
    new Pattern_ArDriveFee   (),
    new Pattern_ArDriveFee2  (),
